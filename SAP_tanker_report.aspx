<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="SAP_tanker_report.aspx.cs" EnableEventValidation="false" Inherits="SAP_tanker_report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
            SAP Puff/Tankers<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
            <li><a href="#">SAP Reports</a></li>
            <li><a href="#">SAP Puff/Tankers</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>SAP Puff/Tankers Details
                </h3>
            </div>
            <div class="box-body">
                        ...
                        <table>
                            <tr>
                                <td>
                                    ...
                                    <asp:DropDownList ID="ddlStatus" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlType_SelectedIndexChanged">
                                        <asp:ListItem>Own Tanker</asp:ListItem>
                                        <asp:ListItem>Others Tanker</asp:ListItem>
                                        <asp:ListItem>Tanker Diesel</asp:ListItem>
                                        <asp:ListItem>Puff Diesel</asp:ListItem>
                                        <asp:ListItem>Own Puff Plant</asp:ListItem>
                                        <asp:ListItem>Own Puff SO</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                                <td style="width: 5px;">
                                </td>
                                   <td>
                                        <asp:Panel ID="hideroutes" runat="server" Visible="false">
                                            <asp:Label ID="Label2" runat="server" Text="Label">Route</asp:Label>&nbsp;
                                ...
                                <td>
                                    ...
                                    <asp:CalendarExtender ID="enddate_CalendarExtender" runat="server" Enabled="True"
                                        TargetControlID="txt_FromDate" Format="dd-MM-yyyy HH:mm">
                            ...
                            <div id="divPrint">
                                <div style="width: 100%;">
                                    ...
                                    <div style="left: 0%; text-align: center;">
                                        ...
                                        <div align="center">
                                            <span style="font-size: 18px; text-decoration: underline; color: #0252aa;">SAP Puff/Tanker Details</span>
                                        </div>
                                        <div align="center">
