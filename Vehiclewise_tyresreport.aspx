<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="Vehiclewise_tyresreport.aspx.cs" Inherits="Vehiclewise_tyresreport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
            Vehiclewise Tyres Report<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Trip Reports</a></li>
            <li><a href="#">Vehiclewise Tyres Report</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Vehiclewise Tyres Details
                </h3>
            </div>
            <div class="box-body">
                    ...
                    <ContentTemplate>
                        <div id="divPrint">
                            <div style="width: 100%;">
                                ...
                                <div align="center">
                                    <span style="font-size: 18px; font-weight: bold; color: #0252aa;">Vehiclewise Tyre's Report</span><br />
                                    <div>
                                    </div>
                                </div>
                                <div>
