<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true"
    CodeFile="Tally_tanker_report.aspx.cs" Inherits="Tally_tanker_report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
            Tally Puff/Tankers<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
            <li><a href="#">Tally Reports</a></li>
            <li><a href="#">Tally Puff/Tankers</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Tally Puff/Tankers Details
                </h3>
            </div>
            <div class="box-body">
                                ...
                                <td>
                                 ...
                                 <td>
                                        <asp:Panel ID="hidevehicles" runat="server" Visible="false">
                                            <asp:Label ID="Label3" runat="server" Text="Label">Vehicle</asp:Label>&nbsp;
                            ...
                            <div id="divPrint">
                                <div style="width: 100%;">
                                    ...
                                    <div style="left: 0%; text-align: center;">
                                        ...
                                        <div align="center">
                                            <span style="font-size: 18px; text-decoration: underline; color: #0252aa;">Tally Puff/Tanker Details</span>
                                        </div>
                                        <div align="center">
