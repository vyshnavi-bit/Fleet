<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="FuelTankMileageReport.aspx.cs" Inherits="FuelTankMileageReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <asp:UpdateProgress ID="updateProgress1" runat="server">
    ...
    <section class="content-header">
        <h1>
           Fuel Tank Mileage Report<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Trip Reports</a></li>
            <li><a href="#">Fuel Tank Mileage Report</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Fuel Tank Mileage Details
                </h3>
            </div>
            <div class="box-body">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <asp:DropDownList ID="ddlType" runat="server" CssClass="form-control" AutoPostBack="True"
                                            ...
                                            <asp:ListItem>All Puff</asp:ListItem>
                                            <asp:ListItem>All Tanker</asp:ListItem>
                                            <asp:ListItem>Driver Wise</asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                ...
                                <div id="divPrint">
                                    <div style="width: 100%;">
                                        ...
                                        <div align="center" style="width:100%;">
                                            <span style="font-size: 18px; font-weight: bold; color: #0252aa;">Fuel Tank Mileage Report</span><br />
