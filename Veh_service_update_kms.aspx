<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="Veh_service_update_kms.aspx.cs" Inherits="Veh_service_update_kms" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        function closevehicleservicedetails() {
            $('.hiddenrow').hide();
            $('#vehser_fillform').css('display', 'none');
            $('#vehservice_showlogs').css('display', 'block');
            $('#div_vehservicesdata').show();
        ...
        function save_Veh_Servicing_update_kms_click() {
            var veh_sno = document.getElementById('slct_vehicle_no').value;
            var flag = false;
            ...
            var data = { 'op': 'save_Veh_Servicing_update_kms_click', 'vehsno': veh_sno, 'eoc': txt_eoc, 'goc': txt_goc, 'ofc': txt_ofc, 'afc': txt_afc, 'brakefluid': txt_brakefluid, 'powersteeringfluid': txt_powersteeringfluid, 'transmissionfluid': txt_transmissionfluid, 'washerfluid': txt_washerfluid, 'checkbrakes': txt_checkbrakes, 'checkleaks': txt_checkleaks, 'allbelts': txt_allbelts, 'lubricatechassis': txt_lubricatechassis, 'airchecking': txt_airchecking, 'tyreinterchanging': txt_tyreinterchanging, 'btnval': btnval, 'sno': sno };
            var s = function (msg) {
                if (msg) {
                    get_vehicleServicealerts_details();
                    clearServicesalerts();
        ...
        function get_vehicleServicealerts_details() {
            var data = { 'op': 'get_vehicleservice_update_kms_details' };
            var s = function (msg) {
                if (msg) {
                    if (msg.length > 0) {
        ...
        function fillServicingdetails(msg) {
            ...
            results += '<thead><tr style="background:#5aa4d0; color: white; font-weight: bold;"><th scope="col" style="font-weight: bold;"></th><th scope="col" style="font-weight: bold;">VehicleNumber</th><th scope="col" style="font-weight: bold;">EOC</th><th scope="col" style="font-weight: bold;">GOC</th><th scope="col" style="font-weight: bold;">AFC</th><th scope="col" style="font-weight: bold;">OFC</th><th scope="col" style="font-weight: bold;">BrakeFluid</th><th scope="col" style="font-weight: bold;">SteeringFluid</th><th scope="col" style="font-weight: bold;">TransmissionFluid</th><th scope="col" style="font-weight: bold;">WasherFluid</th><th scope="col" style="font-weight: bold;">Brakes&Bearings</th><th scope="col" style="font-weight: bold;">CheckLeaks</th><th scope="col" style="font-weight: bold;">AllBelts</th><th scope="col" style="font-weight: bold;">LubricateChassis</th></tr></thead></tbody>';
            for (var i = 0; i < msg.length; i++) {
                ...
                //results += '<th scope="row" class="1">' + msg[i].vehicleno + '</th>';
                results += '<td class="1" style="font-weight: 600;"><i class="fa fa-truck" aria-hidden="true"></i>&nbsp;<span id="1">' + msg[i].vehicleno + '</span></td>';
            ...
            results += '</table></div>';
            $("#div_vehservicesdata").html(results);
        }
        function getme(thisid) {
            ...
            document.getElementById('txt_ofc').value = OFC;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <section class="content-header">
        <h1>
            Vehicle Service Update Kms<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Operations</a></li>
            <li><a href="#">Vehicle Service Update Kms</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Vehicle Service Update Kms
                </h3>
            </div>
            <div class="box-body">
                <div id="vehservice_showlogs" >
                   <%-- <input id="add_partnumber" type="button" class="btn btn-primary" name="submit" value='Add Vehicle Service Update Kms' />--%>
                   <div class="input-group" style="width: 100px;padding-left: 920px;">
                            <div class="input-group-addon">
                            <span  class="glyphicon glyphicon-plus-sign" onclick="addvehicleviceupdate()"></span><span id="add_partnumber" onclick="addvehicleviceupdate()">Add Vehicle Service</span>
                        </div>
                        </div>
                    <br />
                </div>
                <div id="div_vehservicesdata" style="background: #ffffff">
                </div>
                <div id='vehser_fillform' style="padding: 20px; display: none;">
                    ...
                    <div align="center">
                        <%--<input id='btn_save' type="button" class="btn btn-primary" name="submit" value='Save'
                            onclick="save_Veh_Servicing_update_kms_click()" />
                        <input id='close_vehserupd' type="button" class="btn btn-danger" name="Close" value='Close' />--%>
                        <table>
                                <tr>
                                <td>
                                </td>
                                <td>
                                    <div class="input-group">
                                        <div class="input-group-addon">
                                        <span class="glyphicon glyphicon-ok" id="btn_save1" onclick="save_Veh_Servicing_update_kms_click()"></span><span id="btn_save" onclick="save_Veh_Servicing_update_kms_click()">Save</span>
                                  </div>
                                  </div>
                                    </td>
                                    ...
                                    <td>
                                     <div class="input-group">
                                        ...
                                        <span class="glyphicon glyphicon-remove" id='close_vehmaster1' onclick="closevehicleservicedetails()"></span><span id='close_vehserupd' onclick="closevehicleservicedetails()">Close</span>
                                  </div>
                                  </div>
                            </td>
                            </tr>
