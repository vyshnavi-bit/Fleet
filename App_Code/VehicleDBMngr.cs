...
public class VehicleDBMgr
{
    ...
    {
        //Go4Hosting
        //conn.ConnectionString = @"SERVER=49.50.79.13;DATABASE=vyshnavi_fleetmanagement;UID=vyshnavi_root;PASSWORD=Vyshnavi@123;";
        //LIVE
         conn.ConnectionString = @"SERVER=120.138.9.118;DATABASE=vyshnavi_fleetmanagement;UID=vyshnavi_root;PASSWORD=Vyshnavi@123;";
        //Windows test in Ctrls
       // conn.ConnectionString = @"SERVER=182.18.162.51;DATABASE=vyshnavi_fleetmanagement;UID=admin;PASSWORD=CK!uM$Btz2#4c$;";
    }
