<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="OverallDieselMaintanenceReport.aspx.cs" Inherits="OverallDieselMaintanenceReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        function fill_FuelVendorsList(msg) {
            var data = document.getElementById('slct_FuelVendorsList');
            var length = data.options.length;
            document.getElementById('slct_FuelVendorsList').options.length = null;
            var opt = document.createElement('option');
            opt.innerHTML = "Select FuelVendorsList";
            opt.value = "Select FuelVendorsList";
        ...
        function btnsaveInwardstock() {
            ...
            var supplierid = document.getElementById('slct_FuelVendorsList').value;
            if (Qty == "") {
                alert("Enter Inward Diesel");
                $('#txtInwardDiesel').focus();
                return false;
            }
            if (supplierid == "Select FuelVendorsList") {
                alert("select Fuel Supplier");
                $("slct_FuelVendorsList").focus();
                return false;
            }

            var data = { 'op': 'btnsaveInwardstock', 'Qty': Qty, 'txtOppQty': txtOppQty, 'litercost': litercost, 'supplierid': supplierid };
            var s = function (msg) {
                if (msg) {
                    alert(msg);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <section class="content-header">
        <h1>
            OverallDiesel Details<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Operations</a></li>
            <li><a href="#">OverallDiesel Details</a></li>
        </ol>
    </section>
 ...
 <table align="center" >
            <tr>
                ...
                <td>
                    <select id="slct_FuelVendorsList" class="form-control">
                        <option selected disabled value="Select FuelVendorsList"></option>
                    </select>
                </td>
        ...
        <tr>
         <td>
            ...
            <tr>
                ...
                <td  style="height:40px;">
                <input type="text" id="txtClosingStock" style="font-size:18px; font-weight:bold; color:red;" class="form-control" placeholder="Enter Inward Diesel" />
                </td>
            </tr>
             <%--<tr>
                <td>
