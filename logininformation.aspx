    ...
    function filldetails_fill(msg) {
        ...
        for (var i = 0; i < msg.length; i++) {
            ...
            if (loginstatuss == "Active") {
                ...
                results += '<td  class="1" style="text-align:center;">' + msg[i].employeename + '</td>';
                    ...
                    <table>
                        <tr>
                          <td>
                            ...
                            <td>
                            <input id="btn_save" type="button" class="btn btn-success" name="submit" value='Get Details'
                                        onclick="btn_getlogininfoemployee_details()" />
                                        </td>
                     </tr>
                    </table>
                </div>
                     ...
                     <td>
                           ...
                           <%-- <td>
                            ...
                            <input id="Button1" type="button" class="btn btn-success" name="submit" value='Get Details'
                                        onclick="btn_getlogininfodatewise_details()" />
                                        </td>
                  </tr>
                  </table>
                </div>
