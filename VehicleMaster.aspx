...
//            });
        ...
        function closevehicledocuments() {
            $('.hiddenrow').hide();
            $('#vehmaster_fillform').css('display', 'none');
            $('#vehmaster_showlogs').css('display', 'block');
            $('#div_vehmaster_table').css('display', 'block');
        ...
        function save_vehmaster_click() {
            ...
            var btnval = document.getElementById('save_vehmaster').innerHTML;
            ...
            var petro_ledgername = document.getElementById('txt_petro_ledgername').value;
            var petro_ledgercode = document.getElementById('txt_petro_ledgercode').value;
            var whscode = document.getElementById('txt_whscode').value;
                ...
                var s = function (msg) {
                    if (msg) {
                        for (var i = 0; i < axil_table.length; i++) {
                            ...
                            var s = function (msg) {
                                if (msg == 'Y') {
                                    var Data = { 'op': 'save_vehicle_master','whscode':whscode, 'ledgercode':ledgercode,'petro_ledgercode':petro_ledgercode, 'petro_ledgername': petro_ledgername, 'ledgername': ledgername, 'regno': regno, 'doorno': doorno, 'vehtype': vehtype, 'sno': sno, 'btnval': btnval, 'status': status, 'Capacity': Capacity,
                                        ...
                                        if (msg) {
                                            if (msg.length > 0) {
                                                if (msg == "OK") {
                                                    ...
                                                    document.getElementById('save_vehmaster').innerHTML = "Save";
                                                    clearall();
                                                    retrivedata();
                                                    hiding_error();
                                                    get_tyresdata();
        ...
        function vehiclenochange() {
            ...
            if (vehicleno == undefined || vehicleno == "" || vehicleno == null) {
                retrivedata();
            }
            var table = document.getElementById("tbl_vehmaster");
            for (var i = table.rows.length - 1; i > 0; i--) {
            ...
            for (var i = 0; i < results.length; i++) {
                if (vehicleno == results[i].registration_no) {
                    if (results[i].VehType != null) {
                        ...
                        var petroledgername = results[i].petroledgername;
                        var ledgercode = results[i].ledgercode;
                        var petro_ledgercode = results[i].petro_ledgercode;
                        var whscode = results[i].whscode;
                        ...
                        if (imageloc == "" || imageloc == undefined || imageloc == null) {
                            $('#tbl_vehmaster').append('<tr style="background-color:' + colorue[k] + '"><td style="font-weight: 600;"><i class="fa fa-truck" aria-hidden="true"></i>&nbsp;<span id="1">' + registration_no + '</span></td><td scope="row"  style="display:none;">' + registration_no + '</td><td data-title="Vehicle Type">' + VehType + '</td><td data-title="Door No" >' + door_no + '</td><td ><i  aria-hidden="true"></i>&nbsp;<span id="1">' + status + '</span></td><td data-title="Status" style="display:none;" >' + status + '</td><td data-title="sno" style="display:none;">' + vm_sno + '</td><td ><i class="fa  fa-balance-scale" aria-hidden="true"></i>&nbsp;<span id="1">' + capcity + '</span></td><td data-title="Capacity" style="display:none;">' + capcity + '</td><td data-title="Vehicle Make">' + vehmake + '</td><td ><span id="1">' + fuelcapacity + '</span></td><td data-title="Fuel Capacity" style="display:none;">' + fuelcapacity + '</td><td data-title="AxilName_sno" style="display: none;">' + axil_name + '</td><td ><i class="fa  fa-life-saver" aria-hidden="true"></i>&nbsp;<span id="1">' + axilmstr_name + '</span></td><td data-title="AxilName" style="display:none;">' + axilmstr_name + '</td><td data-title="act_mileage" style="display:none;">' + act_mileage + '</td><td data-title="insurancesno" style="display:none;">' + insurancesno + '</td><td data-title="permitstatename" style="display:none;">' + permitstatename + '</td><td data-title="permit_state_expdate" style="display:none;">' + permit_state_expdate + '</td><td data-title="stateroadtax" style="display:none;">' + stateroadtax + '</td><td data-title="stateroadtaxexp_date" style="display:none;">' + stateroadtaxexp_date + '</td><td data-title="stateroadtaxexp_date" style="display:none;">' + batteryno + '</td><td data-title="stateroadtaxexp_date" style="display:none;">' + batteryno2 + '</td><td data-title="stateroadtaxexp_date" style="display:none;">' + img_url + '</td><td data-title="stateroadtaxexp_date" style="display:none;">' + ledgername + '</td><td data-title="stateroadtaxexp_date" style="display:none;">' + petroledgername + '</td><td data-title="stateroadtaxexp_date" style="display:none;">' + ledgercode + '</td><td data-title="stateroadtaxexp_date" style="display:none;">' + petro_ledgercode + '</td><td data-title="stateroadtaxexp_date" style="display:none;">' + whscode + '</td><td style="cursor:pointer;"><img data-imagezoom="true" class="img-circle img-responsive" id="main_img_sup" alt="Item Image" src="Images/dummy_image.jpg" style="width: 30px; height: 30px;cursor:pointer;" /></td><td><button type="button" title="Click Here To Edit!" class="btn btn-info btn-outline btn-circle btn-lg m-r-5 editcls" name="Update" value ="Modify"  onclick="updateclick(this)"><span class="glyphicon glyphicon-edit" style="top: 0px !important;"></span></button></td></tr>');
                        }
                        else {
                            $('#tbl_vehmaster').append('<tr style="background-color:' + colorue[k] + '"><td style="font-weight: 600;"><i class="fa fa-truck" aria-hidden="true"></i>&nbsp;<span id="1">' + registration_no + '</span></td><td scope="row"  style="display:none;">' + registration_no + '</td><td data-title="Vehicle Type">' + VehType + '</td><td data-title="Door No" >' + door_no + '</td><td ><i  aria-hidden="true"></i>&nbsp;<span id="1">' + status + '</span></td><td data-title="Status" style="display:none;" >' + status + '</td><td data-title="sno" style="display:none;">' + vm_sno + '</td><td ><i class="fa  fa-balance-scale" aria-hidden="true"></i>&nbsp;<span id="1">' + capcity + '</span></td><td data-title="Capacity" style="display:none;">' + capcity + '</td><td data-title="Vehicle Make">' + vehmake + '</td><td ><span id="1">' + fuelcapacity + '</span></td><td data-title="Fuel Capacity" style="display:none;">' + fuelcapacity + '</td><td data-title="AxilName_sno" style="display: none;">' + axil_name + '</td><td ><i class="fa  fa-life-saver" aria-hidden="true"></i>&nbsp;<span id="1">' + axilmstr_name + '</span></td><td data-title="AxilName" style="display:none;">' + axilmstr_name + '</td><td data-title="act_mileage" style="display:none;">' + act_mileage + '</td><td data-title="insurancesno" style="display:none;">' + insurancesno + '</td><td data-title="permitstatename" style="display:none;">' + permitstatename + '</td><td data-title="permit_state_expdate" style="display:none;">' + permit_state_expdate + '</td><td data-title="stateroadtax" style="display:none;">' + stateroadtax + '</td><td data-title="stateroadtaxexp_date" style="display:none;">' + stateroadtaxexp_date + '</td><td data-title="stateroadtaxexp_date" style="display:none;">' + batteryno + '</td><td data-title="stateroadtaxexp_date" style="display:none;">' + batteryno2 + '</td><td data-title="stateroadtaxexp_date" style="display:none;">' + img_url + '</td><td data-title="stateroadtaxexp_date" style="display:none;">' + ledgername + '</td><td data-title="stateroadtaxexp_date" style="display:none;">' + petroledgername + '</td><td data-title="stateroadtaxexp_date" style="display:none;">' + ledgercode + '</td><td data-title="stateroadtaxexp_date" style="display:none;">' + petro_ledgercode + '</td><td data-title="stateroadtaxexp_date" style="display:none;">' + whscode + '</td><td style="cursor:pointer;"><img data-imagezoom="true" class="img-circle img-responsive" id="main_img_sup" alt="Item Image" src="' + img_url + '" style="width: 30px; height: 30px;cursor:pointer;" /></td><td><button type="button" title="Click Here To Edit!" class="btn btn-info btn-outline btn-circle btn-lg m-r-5 editcls" name="Update" value ="Modify"  onclick="updateclick(this)"><span class="glyphicon glyphicon-edit" style="top: 0px !important;"></span></button></td></tr>');
                        }
                        k = k + 1;
                        if (k == 4) {
                            k = 0;
        ...
        function updateclick(thisid) {
            ...
            Veh_sno = row[0].cells[6].innerHTML;
            var registration_no = row[0].cells[1].innerHTML;
            vehiclesno = Veh_sno;
            reg_no = row[0].cells[1].innerHTML;
            var VehType = row[0].cells[2].innerHTML;
            var door_no = row[0].cells[3].innerHTML;
            var statuscode = row[0].cells[5].innerHTML;
            var vm_sno = row[0].cells[6].innerHTML;
            var capacity = row[0].cells[8].innerHTML;
            var vehmake = row[0].cells[9].innerHTML;
            var fuelcapacity = row[0].cells[11].innerHTML;
            var axilname = row[0].cells[12].innerHTML;
            axilname_sno = row[0].cells[12].innerHTML;
            var act_mileage = row[0].cells[15].innerHTML;
            var insurancesno = row[0].cells[16].innerHTML;
            var batteryno = row[0].cells[21].innerHTML;
            var batteryno2 = row[0].cells[22].innerHTML;
            var imageurl = row[0].cells[23].innerHTML;
            var status = "";
            ...
            document.getElementById('lbl_topempname').innerHTML = row[0].cells[1].innerHTML;
            document.getElementById('lbl_topemployeeid').innerHTML = row[0].cells[2].innerHTML;
            document.getElementById('lbl_topempemailid').innerHTML = row[0].cells[9].innerHTML;
            document.getElementById('lbl_topempmobno').innerHTML = row[0].cells[8].innerHTML;
            ...
            document.getElementById('txt_permitstatename').value = row[0].cells[17].innerHTML;
            document.getElementById('txt_permit_state_expdate').value = row[0].cells[18].innerHTML;
            document.getElementById('txt_stateroadtax').value = row[0].cells[19].innerHTML;
            document.getElementById('txt_stateroadtaxexp_date').value = row[0].cells[20].innerHTML;
            document.getElementById('txt_ledgername').value = row[0].cells[24].innerHTML;
            document.getElementById('txt_ledgercode').value = row[0].cells[26].innerHTML;

            document.getElementById('txt_petro_ledgername').value = row[0].cells[25].innerHTML;
            document.getElementById('txt_petro_ledgercode').value = row[0].cells[27].innerHTML;
            document.getElementById('txt_whscode').value = row[0].cells[28].innerHTML;
            ...
            $('#vehmaster_showlogs').css('display', 'none');
            $('#div_vehmaster_table').css('display', 'none');
            document.getElementById('save_vehmaster').innerHTML = "Modify";
            ...
            for (var i = 0; i < TyreInformation.length; i++) {
                for (var n = 0; n < TyreInformation[i].tyredata.length; n++) {
                    if (TyreInformation[i].tyredata[n].SVDSNo == Tyreno) {
                        content += "SVDSNo : " + TyreInformation[i].tyredata[n].SVDSNo + "<br/>" + "Position : " + TyreInformation[i].tyredata[n].tyre_name + "<br/>" + "Brand : " + TyreInformation[i].tyredata[n].Brand + "<br/>" + "Grove : " + TyreInformation[i].tyredata[n].grove + "<br/>" + "TyreNo : " + TyreInformation[i].tyredata[n].Tyre_Name + "<br/>" + "Tyre Size : " + TyreInformation[i].tyredata[n].tyresize + "<br/>" + "Total Kms : " + TyreInformation[i].tyredata[n].currentkms;
                    }
                }
            }
        ...
        function clearall() {
            ...
            document.getElementById('txt_petro_ledgername').value = "";
            document.getElementById('txt_petro_ledgercode').value = "";
            document.getElementById('txt_whscode').value = "";
            $('#tyre_ass_done').hide();
        }
        var tyres_data = [];
        ...
        function fillemployee_Uploaded_Documents(msg) {
            ...
            for (var i = 0; i < msg.length; i++) {
                ...
                results += '<td data-title="Code" class="2">' + msg[i].photo + '</td>';
                ...
                <div id="vehmaster_showlogs">
                    <table>
                        <tr>
                            ...
                            <td>
                            <div class="input-group" style="padding-left: 740px;">
                                <div class="input-group-addon">
                                <span  class="glyphicon glyphicon-plus-sign" onclick="addvehiclemaster()"></span><span onclick="addvehiclemaster()">Add Vehicle</span>
                          </div>
                          </div>
                            </td>
                        </tr>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-3 text-center">
                                                    <div class="pictureArea1">
                                                        ...
                                                        <div style="width: 10px;padding-left: 42px;">
                                                            <input type="button" id="btn_upload_profilepic" class="btn btn-primary" onclick="upload_profile_pic();"
                                                               ...
                                                               <%-- <div class="input-group">
                                                                    <div class="input-group-addon">
                                                                    <span class="glyphicon glyphicon-upload" id="btn_upload_profilepic1" onclick="btn_upload_profilepic()"></span> <span id="btn_upload_profilepic" onclick="btn_upload_profilepic()">Upload Vehicle Pic</span>
                                                                </div>
                                                               </div>--%>
                                                        </div>
                                                    </div>
                            ...
                            <table align="center" style="width: 90%;">
                                ...
                                <tr>
                                  <td>
                                        <label>
                                            Ledger Code</label>
                                        <input id="txt_ledgercode" type="text" class="form-control" name="vendorcode"
                                  ...
                                  <td style="width: 5px;">
                                    ...
                                    <td>
                                        <label>
                                            Ledger Name</label>
                                        <input id="txt_ledgername" type="text" class="form-control" name="vendorcode"
                                    ...
                                    <td>
                                        <label>
                                            WHS Code</label>
                                        <input id="txt_whscode" type="text" class="form-control" name="vendorcode"
                                ...
                                <tr>
                                 <td>
                                        <label>
                                           Petro Ledger Code</label>
                                        <input id="txt_petro_ledgercode" type="text" class="form-control" name="vendorcode"
                                            placeholder="Petro Ledger Code" />
                                    </td>
                                     <td style="width: 5px;">
                                    </td>
                                <td>
                                        <label>
                                           Petro Ledger Name</label>
                                        <input id="txt_petro_ledgername" type="text" class="form-control" name="vendorcode"
                                            placeholder="Petro Ledger Name" />
                                    </td>
                                </tr>
                            </table>
                            ...
                            <div style="padding-left: 465px;">
                                ...
                                <table>
                                   <tr>
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon">
                                        <span class="glyphicon glyphicon-ok" id="save_vehmaster1" onclick="save_vehmaster_click()"></span><span id="save_vehmaster" onclick="save_vehmaster_click()">Save</span>
                                  </div>
                                  </div>
                                    </td>
                                    ...
                                    <td>
                                     <div class="input-group">
                                        ...
                                        <span class="glyphicon glyphicon-remove" id='close_vehmaster1' onclick="closevehiclemaster()"></span><span id='close_vehmaster' onclick="closevehiclemaster()">Close</span>
                                  </div>
                                  </div>
                                    </td>
                                    </tr>
                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div>
                                                ...
                                                <div style="width: 0px;">
                                                    <%--input id="btn_upload_document" type="button" class="btn btn-primary" name="submit"
                                                        ...
                                                        margin-top: 25px;">--%>
                                                         <div class="input-group">
                                                            <div class="input-group-addon">
                                                            <span class="glyphicon glyphicon-upload" id="btn_upload_document1" onclick="upload_Vehicle_Document_Info()"></span> <span id="btn_upload_document" onclick="upload_Vehicle_Document_Info()">Upload</span>
                                                        </div>
                                                        </div>
                                                </div>
                                            </div>
                                     ...
                                     <div class="input-group">
                                        <div class="input-group-close">
                                        <span class="glyphicon glyphicon-remove" id='close_documents1' onclick="closevehicledocuments()"></span> <span id='close_documents' onclick="closevehicledocuments()">Close</span>
                                  </div>
                                  </div>
                                    </td>
                                            </tr>
