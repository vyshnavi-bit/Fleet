<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true"
    CodeFile="PrintJobCard.aspx.cs" Inherits="PrintJobCard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="second_div" style=" padding: 20px;">
        <div class="tab-content">
                ...
                <contenttemplate>
                    ...
                    <div id="divPrint">
                        ...
                        <asp:GridView ID="grdReports" runat="server" CellPadding="5" CellSpacing="5" CssClass="gridcls"
                            ForeColor="White" GridLines="Both" Height="300px" Width="100%" Font-Size="Small">
            ...
            <br />
            <br />
            <asp:Button ID="btnPrint" runat="Server" CssClass="btn btn-primary" Style="height: 25px;
