<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" EnableEventValidation="false"
    CodeFile="MileageReport.aspx.cs" Inherits="MileageReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
            Mileage Report<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Mileage Details
                </h3>
            </div>
            <div class="box-body">
                                ...
                                <div id="divPrint">
                                    <div style="width: 100%;">
                                        ...
                                        <div align="center" style="width:100%;">
                                            <span style="font-size: 18px; font-weight: bold; color: #0252aa;">Mileage Report</span><br />
