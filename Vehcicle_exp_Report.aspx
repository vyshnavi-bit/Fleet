<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" EnableEventValidation="false"
    CodeFile="Vehcicle_exp_Report.aspx.cs" Inherits="Vehcicle_exp_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdateProgress ID="updateProgress1" runat="server">
      ...
      <section class="content-header">
        <h1>
            Vehcicle Expenditure Report<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Trip Reports</a></li>
            <li><a href="#">Vehcicle Expenditure Report</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Vehcicle Expenditure Details
                </h3>
            </div>
            <div class="box-body">
                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <asp:DropDownList ID="ddlType" runat="server" CssClass="ddlclass" AutoPostBack="True"
                        ...
                        <td>
                            ...
                            <asp:TextBox ID="txt_FromDate" runat="server" CssClass="txtClass"></asp:TextBox>
                        ...
                        <td>
                            ...
                            <asp:TextBox ID="txt_Todate" runat="server" CssClass="txtClass">
                            </asp:TextBox>
                ...
                <asp:Panel ID="hidepanel" runat="server" Visible='false'>
                    <div id="divPrint">
                        <div style="width: 100%;">
                            ...
                            <div align="center">
                                <span style="font-size: 18px; font-weight: bold; color: #0252aa;">Vehcle Expendature Report</span><br />
                                <div>
                                </div>
                            </div>
