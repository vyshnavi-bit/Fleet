<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" EnableEventValidation="false"
    CodeFile="VehicleToolsIssueReport.aspx.cs" Inherits="VehicleToolsIssueReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
            Vehicle ToolsIssue Report<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Trip Reports</a></li>
            <li><a href="#">Vehicle ToolsIssue Report</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Vehicle ToolsIssue Details
                </h3>
            </div>
            <div class="box-body">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:DropDownList ID="ddlissuereturntype" runat="server" CssClass="form-control">
                                            <asp:ListItem>Select Type</asp:ListItem>
                            ...
                            <asp:Panel ID="hidepanel" runat="server" Visible='false'>
                                <div id="divPrint">
                                    <div style="width: 100%;">
                                        ...
                                        <div align="center">
                                            <span style="font-size: 18px; font-weight: bold; color: #0252aa;">Vehicle Tools Issue
                                                & Return Report</span><br />
                                            <div>
                                            </div>
                                        </div>
