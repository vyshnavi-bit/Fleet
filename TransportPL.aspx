<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" EnableEventValidation="false"
    CodeFile="TransportPL.aspx.cs" Inherits="TransportPL" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                    Transport P & L<small>Preview</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i>Operations</a></li>
                    <li><a href="#"> Transport P & L</a></li>
                </ol>
            </section>
            <section class="content">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i style="padding-right: 5px;" class="fa fa-cog"></i> Transport P & L Details
                        </h3>
                    </div>
                    <div class="box-body">
                        <div align="center">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:DropDownList ID="ddltermloanType" runat="server" CssClass="ddlclass">
                                            <asp:ListItem>With TL</asp:ListItem>
                                            <asp:ListItem>Without TL</asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                    <td>
                            ...
                            <asp:Panel ID="hidepanel" runat="server" Visible='false'>
                                <div id="divPrint">
                                    <div style="width: 100%;">
                                        ...
                                        <div align="center">
                                            <span style="font-size: 18px; font-weight: bold; color: #0252aa;">Transportation P&L
                                                Report</span><br />
                                            <div>
                                            </div>
                                        </div>
