    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table align="center">
                <tr>
                    <td>
                        <asp:Label ID="Label1" runat="server" Text="Label">Report Type</asp:Label>&nbsp;
                        <asp:DropDownList ID="ddlReportType" runat="server" CssClass="form-control">
                            <asp:ListItem>Daily Diesel</asp:ListItem>
                            <asp:ListItem>Diesel Report</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td>
                    ...
                    <td>
                        <asp:Button ID="btnGenerate" Text="Generate" runat="server" OnClientClick="OrderValidate();"
                            class="btn btn-primary" OnClick="btnGenerate_Click" />
                    </td>
                    <td>
