<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="TyreTransaction.aspx.cs" Inherits="TyreTransaction" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdateProgress ID="updateProgress1" runat="server">
     ...
     <section class="content-header">
        <h1>
            Tyre Transaction Report<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Trip Reports</a></li>
            <li><a href="#">Tyre Transaction Report</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Tyre Transaction Details
                </h3>
            </div>
            <div class="box-body">
                ...
                <div style="width: 100%;">
                    ...
                    <div align="center">
                            <span style="font-size: 18px; font-weight: bold; color: #0252aa;">
                             Tyre Transaction Report</span><br />
                            <div>
                            </div>
                        </div>
                    <div>
